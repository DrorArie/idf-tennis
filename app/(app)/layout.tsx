  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <header className="bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between sticky top-0 z-40">
        <h1 className="text-lg font-bold text-gray-900">🎾 IDF Tennis</h1>
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 flex justify-around py-2 z-40">
        <Link
          href="/dashboard"
          className="flex flex-col items-center gap-0.5 px-6 py-1 text-gray-500 hover:text-blue-600 transition-colors"
        >
